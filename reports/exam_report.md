...
3. category contained a few 'home' and 'short_term' outliers|
1. Mathematically converted prices to a monthly standard (e.g., Weekly * 4), then dropped the price_type column
