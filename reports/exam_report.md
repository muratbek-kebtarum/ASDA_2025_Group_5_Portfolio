...
| Inconsistent categories    |price_type, has_photo, category|1.price_type: Non-monthly values,2.has_photo: Redundant 'Thumbnail' 3.category,category: Outlier property types.|1.Converted to monthly dropped column 2.Merged into 'Yes'
3.Dropped rows and column|
